    ...
    translations: {
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Delete",
          deleteMessage:
            "Are you sure? This action cannot be undone! The tickets from this queue will still exist but won't have any queue assigned to them.",
        },
      },
      queueSelect: {
        inputLabel: "Queues",
      ...
      users: {
        ...
        confirmationModal: {
          deleteTitle: "Delete",
          deleteMessage:
            "All user data will be lost. The open tickets of this user will be moved to the queue.",
        },
      },
      helps: {
        title: "Help Center",
      ...
      backendErrors: {
        ...
        ERR_WAPP_CHECK_CONTACT:
          "Unable to check WhatsApp contact. Check the connections page.",
